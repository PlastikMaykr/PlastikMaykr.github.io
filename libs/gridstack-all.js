                ...
                186: (e, t, i) => {
                    ...
                    class l extends n.DDBaseImplement {
                        ...
                        _removeHelperStyle() {
                            ...
                            if (!(null == t ? void 0 : t._isAboutToRemove) && this.dragElementOriginStyle) {
                                let e = this.helper,
                    ...
                    t.DDDraggable = l, l.originStyleProp = ["transition", "pointerEvents", "position", "left", "top", "minWidth", "willChange"]
                },
                225: (e, t, i) => {
                    Object.defineProperty(t, "__esModule", {
                        value: !0
                ...
                270: function(e, t, i) {
                    ...
                    class p {
                        ...
                        static init(e = {}, t = ".grid-stack") {
                            ...
                            return i ? (i.gridstack || (i.gridstack = new p(i, r.Utils.cloneDeep(e))), i.gridstack) : ("string" == typeof t ? console.error('GridStack.initAll() no grid was found with selector "' + t + '" - element missing or wrong selector ?\nNote: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.') : console.error("GridStack.init() no grid element was passed."), null)
                        }
                        static initAll(e = {}, t = ".grid-stack") {
                            let i = [];
                            return p.getGridElements(t).forEach((t => {
                                t.gridstack || (t.gridstack = new p(t, r.Utils.cloneDeep(e)), delete e.dragIn, delete e.dragInOptions), i.push(t.gridstack)
                        ...
                        addWidget(e, t) {
                            ...
                            } else if (0 === arguments.length || 1 === arguments.length && (void 0 !== (o = e).el || void 0 !== o.x || void 0 !== o.y || void 0 !== o.w || void 0 !== o.h || void 0 !== o.content))
                        ...
                        makeSubGrid(e, t, i, s = !0) {
                            var o, n, l;
                            let a, h = e.gridstackNode;
                            if (h || (h = this.makeWidget(e).gridstackNode), null === (o = h.subGrid) || void 0 === o ? void 0 : o.el) return h.subGrid;
                            let d, g = this;
                            for (; g && !a;) a = null === (n = g.opts) || void 0 === n ? void 0 : n.subGrid, g = null === (l = g.parentGridItem) || void 0 === l ? void 0 : l.grid;
                            t = r.Utils.cloneDeep(Object.assign(Object.assign(Object.assign({}, a || {}), {
                                children: void 0
                            }), t || h.subGrid)), h.subGrid = t, "auto" === t.column && (d = !0, t.column = Math.max(h.w || 1, (null == i ? void 0 : i.w) || 1), t.disableOneColumnMode = !0);
                            let u, c, m = h.el.querySelector(".grid-stack-item-content");
                            if (s) {
                                this._removeDD(h.el);
                                let e = document.implementation.createHTMLDocument("");
                                e.body.innerHTML = '<div class="grid-stack-item"></div>', u = e.body.children[0], u.appendChild(m), c = Object.assign(Object.assign({}, h), {
                                    x: 0,
                                    y: 0
                                }), r.Utils.removeInternalForSave(c), delete c.subGrid, h.content && (c.content = h.content, delete h.content), e.body.innerHTML = '<div class="grid-stack-item-content"></div>', m = e.body.children[0], h.el.appendChild(m), this._prepareDragDropByNode(h)
                            }
                            if (i) {
                                let e = d ? t.column : h.w,
                                    s = h.h + i.h,
                                    o = h.el.style;
                                o.transition = "none", this.update(h.el, {
                                    w: e,
                                    h: s
                                }), setTimeout((() => o.transition = null))
                            }
                            let v = h.subGrid = p.addGrid(m, t);
                            return (null == i ? void 0 : i._moving) && (v._isTemp = !0), d && (v._autoColumn = !0), s && v.addWidget(u, c), i && (i._moving ? window.setTimeout((() => r.Utils.simulateMouseEvent(i._event, "mouseenter", v.el)), 0) : v.addWidget(h.el, h)), v
                        }
                        removeAsSubGrid(e) {
                            var t;
                        ...
                        save(e = !0, t = !1) {
                            ...
                            if (i.forEach((i => {
                                    ...
                                    } else if (e || delete i.content, null === (s = i.subGrid) || void 0 === s ? void 0 : s.el) {
                        ...
                        load(e, t = this.opts.addRemoveCB || !0) {
                            let i = p.Utils.sort([...e], -1, this._prevColumn || this.getColumn());
                            ...
                            return this.batchUpdate(), t && [...this.engine.nodes].forEach((e => {
                                i.find((t => e.id === t.id)) || (this.opts.addRemoveCB && this.opts.addRemoveCB(this, e, !1), o.push(e), this.removeWidget(e.el, !0, !1))
                            })), i.forEach((e => {
                            ...
                            })), this.engine.removedNodes = o, this.batchUpdate(!1), delete this._ignoreLayoutsNodeChange, delete this._insertNotAppend, s ? this.opts.addRemoveCB = s : delete this.opts.addRemoveCB, this
                        }
                        batchUpdate(e = !0) {
                        ...
                        removeWidget(e, t = !0, i = !0) {
                            return p.getElements(e).forEach((e => {
                        ...
                        movable(e, t) {
                            return this.opts.staticGrid || p.getElements(e).forEach((e => {
                                let i = e.gridstackNode;
                        ...
                        _setupAcceptWidget() {
                            ...
                            return g.droppable(this.el, {
                                ...
                                if (delete t._gridstackNodeOrig, a && (null == h ? void 0 : h.grid) && h.grid !== this) {
                                    let e = h.grid;
                                    e.engine.removedNodes.push(h), e._triggerRemoveEvent()._triggerChangeEvent(), e.parentGridItem && !e.engine.nodes.length && e.opts.subGridDynamic && e.removeAsSubGrid()
                                }
                                if (!n) return !1;
                                if (a && (this.engine.cleanupNode(n), n.grid = this), g.off(t, "drag"), i !== t ? (i.remove(), t.gridstackNode = h, a && (t = t.cloneNode(!0))) : (t.remove(), this._removeDD(t)), !a) return !1;
                                ...
                                return r.Utils.copyPos(n, this._readAttr(this.placeholder)), r.Utils.removePositioningStyles(t), this._writeAttr(t, n), t.classList.add(l.gridDefaults.itemClass, this.opts.itemClass), this.el.appendChild(t), d && (d.parentGridItem = n, d.opts.styleInHead || d._updateStyles(!0)), this._updateContainerHeight(), this.engine.addedNodes.push(n), this._triggerAddEvent(), this._triggerChangeEvent(), this.engine.endUpdate(), this._gsEventHandler.dropped && this._gsEventHandler.dropped(Object.assign(Object.assign({}, e), {
                                    type: "dropped"
                                }), h && h.grid ? h : void 0, n), window.setTimeout((() => {
                        ...
                        _dragOrResize(e, t, i, s, o, n) {
                            ...
                            if (this.engine.moveNodeCheck(s, Object.assign(Object.assign({}, a), {
                                ...
                                s._lastUiPosition = i.position, this.engine.cacheRects(o, n, g, d, p, h), delete s._skipDown, l && s.subGrid && s.subGrid.onParentResize(), this._extraDragRow = 0, this._updateContainerHeight();
                                let e = t.target;
                    ...
                    t.GridStack = p, p.Utils = r.Utils, p.Engine = n.GridStackEngine, p.GDRev = "7.2.3"
                },
                699: (e, t) => {
                    Object.defineProperty(t, "__esModule", {
                        value: !0
